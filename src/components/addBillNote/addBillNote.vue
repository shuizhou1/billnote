...
export default {
  ...
  methods: {
    ...
    save() {
      // console.log(this.billNoteName);
      // console.log(this.is_default);
      // console.log(this.color);
      // console.log(this.remarks);
      if (this.billNoteName) {
        this.$http
          .post("http://billing.gzpeifeng.com/user/accountbook/add", {
